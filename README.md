...
##1 코틀린의 시작
특징
자바를대체하기 위한 목적으로 개발된 언어로 언어적으로는 최신의 패러다임을 적용하여 자바의 몇몇 약점들을 개선하면서 기존 자바에서 사용하는 자바 가상머신과 호환될 수 있게 만들어졌다. 코틀린은 자바로 개발이 가능했던 웹서비스 안드로이드 개발뿐아니라 자바 스크립트 및 스위프트와의 연동 개발이 가능하다
